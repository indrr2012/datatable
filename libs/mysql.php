...
class pdoMySQL {
	...
	* @param string $port the port of the database not necessary get default ports. */
	...
	/**
	* @brief connect_to_db, connect to the database.
	...
	* @param string sql_statement is a string with your query. IMPORTANT: sql_statement does not work if contains: group by, having...
